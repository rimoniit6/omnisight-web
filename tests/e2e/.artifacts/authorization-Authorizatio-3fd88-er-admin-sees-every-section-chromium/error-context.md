...
- Name: authorization.spec.ts >> Authorization — role-specific navigation >> super admin sees every section
- Location: tests\e2e\authorization.spec.ts:33:7
